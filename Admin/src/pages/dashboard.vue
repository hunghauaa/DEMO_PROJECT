  ...
  <q-page>
      ...
      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
        <q-card>
          <q-card-section :class="$q.dark.isActive?'blue_dark':'bg-blue-8'" class="text-white">
            <div class="row">
              <div class="col-10">
                <div class="text-h6">Sản phẩm đang giảm giá</div>
                <div class="text-h5">{{toTalSalePro}}</div>
              </div>
              <div class="col-2">
                <q-icon size="62px" name="arrow_downward"/>
              </div>
            </div>
          </q-card-section>
        </q-card>
          ...
          <q-card-section :class="$q.dark.isActive?'green_dark':'bg-green-8'" class="text-white">
            <div class="row">
              <div class="col-10">
                ...
                <div class="text-h5">{{getOrderAdmin.length}}</div>
              </div>
              <div class="col-2">
                <q-icon size="62px" name="o_shopping_cart"/>
              </div>
            </div>
          </q-card-section>
        </q-card>
        ...
        <q-card>
          <q-card-section :class="$q.dark.isActive?'orange_dark':'bg-orange-9'" class="text-white">
            <div class="row">
              ...
              <div class="col-2">
                <q-icon size="62px" name="o_people"/>
              </div>
            </div>
          </q-card-section>
        </q-card>
    ...
    <div>
      <div class="row q-col-gutter-sm q-ma-xs q-mr-sm">
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
          <q-card flat bordered class="">
            <q-card-section class="row">
              <div class="text-h6 col-12">Doanh số vs Mục tiêu
        ...
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
          ...
          <q-card flat bordered class="">
            <q-card-section class="row">
              <div class="text-h6 col-12">Thị phần & Tăng trưởng
        ...
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
          ...
          <q-card flat bordered class="">
            <q-card-section class="row">
              <div class="text-h6 col-12">Doanh số vs Hạn ngạch
    ...
    <div class="row q-col-gutter-sm q-ma-xs q-mr-sm">
      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
        <q-card flat bordered class="">
          <q-card-section>
            <div class="text-h6">Tỷ lệ đơn hàng theo danh mục
      ...
      <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
        <q-card flat bordered class="">
          <q-card-section>
            <div class="text-h6">Doanh thu của các đại diện bán hàng
...
<script>
    ...
    export default {
        ...
        computed: {
          ...mapGetters(["getOrderAdmin","products","users"]),
          toTalSalePro(){
